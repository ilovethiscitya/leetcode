...
class word {
    public String mostCommonWord(String paragraph, String[] banned) {
        ...
        String after = paragraph.toLowerCase().replaceAll("\\W+", " ");
        String[] words = after.split(regex)
        return after;
    }
    public static void main(String[] args) {
        word w = new word();
        String res = w.mostCommonWord("Bob hit a ball, the hit BALL flew far after it was hit.", new String[]{"hit"});
